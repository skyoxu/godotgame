...
function renderTaskDetail(data) {
  ...
  if(data.resource_knowledge){const d=document.createElement('details');const s=document.createElement('summary');s.textContent='Reviewed resource knowledge';const pre=document.createElement('pre');pre.textContent=pretty(data.resource_knowledge);d.append(s,pre);box.append(d);}
