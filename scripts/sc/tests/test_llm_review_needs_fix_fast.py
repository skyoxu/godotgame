            ...
            with (
                ...
                mock.patch.object(
                    ...
                    return_value={
                        ...
                        "doc_only_delta": True,
                        "changed_paths": ["docs/architecture/overlays/PRD-template-T2/08/feature-slice.md"],
                        "unsafe_paths": [],
                    },
                ),
                mock.patch.object(
            ...
            with (
                ...
                mock.patch.object(
                    ...
                    return_value={
                        ...
                        "change_scope": {
                            "deterministic_strategy": "minimal-acceptance",
                            "changed_paths": ["docs/architecture/overlays/PRD-template-T2/08/feature.md"],
                            "task_semantic_paths": ["docs/architecture/overlays/PRD-template-T2/08/feature.md"],
                        },
                    },
                ),
                mock.patch.object(needs_fix_fast, "try_reuse_matching_minimal_acceptance_step", return_value=None),
